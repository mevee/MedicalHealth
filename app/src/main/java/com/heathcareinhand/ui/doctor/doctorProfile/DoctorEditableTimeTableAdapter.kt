...
class DoctorEditableTimeTableAdapter(
    ...
    data class IntroViewHolder(val bind: ScheduleEditableItemBinding) :
        RecyclerView.ViewHolder(bind.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): IntroViewHolder {
        val binding =
            ScheduleEditableItemBinding.inflate(LayoutInflater.from(context), parent, false)
    ...
    override fun onBindViewHolder(holder: IntroViewHolder, position: Int) {
        ...
        val timeSelectAdapter =
            TiimeSlotEditableAdapter(context, dataList) { positionLocal, selectedValue ->
